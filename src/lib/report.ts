...
<h2>Methodology</h2>
<p>Automated attack simulation with taint-tracked dataflow (sources: request params, bodies, forms, argv; sinks report only on confirmed source→sink flows). OWASP Top 10 2021 mapped; each finding carries a CVSS v3.1-style vector, a simulated exploitation path, and remediation.</p>
