...
export const ROADMAP_PHASES: RoadmapPhase[] = [
  {
    ...
    parts: [
      ...
      p(2, "Code intake", "Multi-file paste, drag-and-drop upload, folder zips, and GitHub repo/URL ingestion with language auto-detection.", "up-next"),
      p(3, "Static analysis engine v1", "AST-aware detectors per language, taint tracking from sources to sinks, and dramatically fewer false positives.", "planned"),
      p(4, "Attack simulation lab v1", "Per-finding exploit generation: live payload crafting, exploit chains, and a sandboxed 'try to crack' replay view.", "planned"),
